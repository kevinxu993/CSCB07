...
/**
 * A representation of a Flight Data Recorder (FDR) of an aircraft. Stores
...
public class FlightDataRecorder {
   ...
   * the data points that this FlightDataRecorder stores. The List contains the
   * recorded data points in reverse order: the most recent item will be at
   * index 0.
   * 
   ...
   * FlightDataRecorder (i.e., excludes data points already overwritten). Return
   * 0.0 if no values have been recorded.
   * 
   * @return The average of the data points recorded in this FlightDataRecorder
   *         or 0, if no data points have been recorded.
   */
